...
\title{Implementation of the paper "Dual-Objective Scheduling of Rescue Vehicles to\\
...
\author{Guidolin~Davide,
        Guglielmi~Matteo% <-this % stops a space
...
For this reason we decided to focus our attention on a project that could possibly deal with this problem.
\end{abstract}
